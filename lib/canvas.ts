import { CanvasMouseDown, CanvasMouseMove, CanvasMouseUp, CanvasObjectModified, CanvasPathCreated, CanvasSelectionCreated, CanvasObjectScaling, RenderCanvas } from "@/app/_types/applicationTypes";
...
export const initializeFabric = ({
  ...
  const canvas = new fabric.Canvas(canvasRef.current as unknown as HTMLCanvasElement, {
