import { CustomFabricObject, ImageUpload, ModifyShape, ElementDirection } from "@/app/_types/applicationTypes";
...
/* export const handleImageUpload = ({
  ...
  reader.onload = () => {
    fabric.Image.fromURL(reader.result as string, (img: Object | null) => {
